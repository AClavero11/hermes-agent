...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Hermes works on across turns", "Session",
               args_hint="[text | pause | resume | clear | status]",
               subcommands=("pause", "resume", "clear", "status"),
               gateway_only=True),
    CommandDef("workspace", "Inspect and update durable Workspace tasks/evidence/reports", "Session",
               aliases=("ws",), args_hint="[status|list|add|start|block|done|evidence|inbox|report]",
               subcommands=("status", "list", "add", "start", "block", "done", "evidence", "inbox", "report"),
               gateway_only=True),
    CommandDef("workflow", "Inspect or control production workflow kill switches", "Session",
               aliases=("workflows",), args_hint="[status|list|show|kill|resume|register|report]",
               subcommands=("status", "list", "show", "kill", "resume", "register", "report"),
               gateway_only=True),
    CommandDef("ops", "Show AAC business operating brief and catch-up lanes", "Session",
               aliases=("business", "bizops"), args_hint="[brief|score|workflows]",
    ...
    CommandDef("kill", "Disable a named workflow kill switch", "Session",
               ...
               gateway_only=True),
    CommandDef("kanban", "Manage durable multi-agent Kanban tasks", "Session",
               aliases=("kb",), args_hint="[list|create|workflow|brief|show|block|unblock|complete|watch]",
               subcommands=("init", "list", "ls", "create", "show", "assign", "link", "unlink",
                            "claim", "comment", "complete", "block", "unblock", "archive",
                            "dispatch", "daemon", "watch", "stats", "brief", "workflow", "notify-subscribe",
                            "notify-list", "notify-unsubscribe", "log", "runs", "context", "gc")),
    CommandDef("status", "Show session info", "Session"),
    CommandDef("profile", "Show active profile name and home directory", "Info"),
    CommandDef("runtime", "Show runtime repo/model/health resolver", "Info",
